...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "CanvasGradient|CanvasPattern|CanvasRenderingContext|CanvasRenderingContext2D|DOMError|DeviceAcceleration|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList"
  },
  JSBool: {
    "": "bool/Interceptor;",
    toString$0: function(receiver) {
...
["dart2d", "imageindex.dart", , B, {
  ...
  loadImages: function() {
    var t1, t2, e, t3;
    for (t1 = new H.ListIterator($.get$imageSources(), 1, 0, null); t1.moveNext$0();) {
      t2 = C.JSString_methods.$add("./img/", t1._current);
...
["sunflower", "keystate.dart", , B, {
  ...
  }, "call$1", "onKeyUp$closure", 2, 0, 8]
}],
["sunflower", "movingsprite.dart", , B, {
  "": "",
  MovingSprite: {
    "": "Sprite;",
    frame$1: function(duration) {
      var t1, t2, t3, t4, t5;
      t1 = this.velocity;
...
["sunflower", "playersprite.dart", , B, {
  "": "",
  PlayerSprite: {
    "": "MovingSprite;velocity,acceleration,position,imageIndex,size,angle",
    static: {"": "PlayerSprite_MAX_SPEED"}
  }
}],
["sunflower", "sprite.dart", , B, {
  "": "",
  Sprite: {
    "": "Object;",
    draw$2: function(context, debug) {
      var t1, t2, t3, t4, center;
      t1 = this.position;
      t2 = t1.x;
      t3 = this.size;
      t4 = t3.x;
      ...
      if (typeof t1 !== "number")
        return t1.$negate();
      context.drawImage(t2, -t3 / 2, -t1 / 2, t3, t1);
    },
    Sprite$6: function(x, y, imageIndex, width, height, angle) {
      ...
      t1 = $.get$images();
      if (imageIndex >= t1.length)
        return H.ioore(t1, imageIndex);
      image = t1[imageIndex];
      t1 = B.Vec2$(null, null);
      this.size = t1;
      t1.x = J.toDouble$0$n(J.get$width$x(image));
      t1.y = J.toDouble$0$n(J.get$height$x(image));
    }
  }
}],
["sunflower", "sunflower.dart", , B, {
  "": "",
  main: [function() {
    J.addEventListener$2$x(W._convertNativeToDart_Window(document.defaultView), "keydown", B.onKeyDown$closure());
    J.addEventListener$2$x(W._convertNativeToDart_Window(document.defaultView), "keyup", B.onKeyUp$closure());
    B.loadImages();
    P.Future_wait($.get$imageFutures(), false).then$1(new B.main_closure());
  }, "call$0", "main$closure", 0, 0, 0],
  step: [function() {
    var now, secs, t1, t2, t3, t4;
    now = P.DateTime$_now();
    secs = (now.millisecondsSinceEpoch - $.lastStep.millisecondsSinceEpoch) / 1000;
    t1 = $.playerSprite;
    t1.toString;
    if ($.get$keysDown().containsKey$1(37))
      t1.angle = t1.angle - 5 * secs;
    if ($.get$keysDown().containsKey$1(39))
      t1.angle = t1.angle + 5 * secs;
    if ($.get$keysDown().containsKey$1(38))
      t1.acceleration = B.Vec2$fromAngle(t1.angle, secs * 10000);
    else if ($.get$keysDown().containsKey$1(40))
      t1.acceleration = B.Vec2$fromAngle(t1.angle, -secs * 10000);
    else
      t1.acceleration = B.Vec2$(null, null);
    B.MovingSprite.prototype.frame$1.call(t1, secs);
    if (t1.velocity.sum$0() > 500) {
      t2 = t1.velocity.normalize$0();
      t3 = t2.x;
      if (typeof t3 !== "number")
        return t3.$mul();
      t2 = t2.y;
      if (typeof t2 !== "number")
        return t2.$mul();
      t1.velocity = B.Vec2$(t3 * 500, t2 * 500);
    }
    t1 = $.get$context();
    t2 = $.get$WIDTH();
    t3 = $.get$HEIGHT();
    t1.clearRect(0, 0, t2, t3);
    t1.fillStyle = "rgba(255, 0, 0, 1)";
    t1.fillRect(0, 0, t2, t3);
    t1.save();
    t3 = $.playerSprite;
    t3.toString;
    B.Sprite.prototype.draw$2.call(t3, t1, true);
    t1.resetTransform();
    t1.fillStyle = "rgba(255, 255, 255, 1)";
    t2 = "vel: " + H.S(t3.velocity);
    t3 = t3.position;
    t4 = t3.x;
    t3 = t3.y;
    t1.fillText(t2, t4, t3);
    t1.restore();
    $.lastStep = now;
    P.Timer_Timer(C.Duration_21000, B.step$closure());
  }, "call$0", "step$closure", 0, 0, 0],
  main_closure: {
    "": "Closure:11;",
    call$1: function(_) {
      var t1;
      $.lastStep = P.DateTime$_now();
      t1 = new B.PlayerSprite(B.Vec2$(null, null), B.Vec2$(null, null), null, null, null, 0);
      t1.Sprite$6(2, 2, 0, null, null, null);
      $.playerSprite = t1;
      t1 = t1.size;
      t1.x = 32;
      t1.y = 32;
...
["sunflower", "vec2.dart", , B, {
  ...
  Vec2: {
    ...
    Vec2$fromAngle$2: function(angle, scale) {
      var t1, t2;
    ...
    static: {Vec2$: function(x, y) {
        ...
        t1.Vec2$2(x, y);
        return t1;
      }, Vec2$fromAngle: function(angle, scale) {
        var t1 = new B.Vec2(null, null);
        t1.Vec2$fromAngle$2(angle, scale);
        return t1;
      }}
  }
}],
...
Isolate.$lazy($, "keysDown", "keysDown", "get$keysDown", function() {
  return P.LinkedHashMap_LinkedHashMap(null, null, null, J.JSNumber, J.JSBool);
});
...
function dart_precompiled($collectedClasses) {
  ...
  function PlayerSprite(velocity, acceleration, position, imageIndex, size, angle) {
  ...
  PlayerSprite.builtin$cls = "PlayerSprite";
  if (!"name" in PlayerSprite)
    PlayerSprite.name = "PlayerSprite";
  $desc = $collectedClasses.PlayerSprite;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PlayerSprite.prototype = $desc;
  function Sprite() {
  }

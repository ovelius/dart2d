...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    final htmlDomBindingsModule = _$HtmlDomBindingsModule();
    gh.factory<_i988.HtmlScreen>(() => htmlDomBindingsModule.screen);
    gh.factory<_i988.WorldCanvas>(() => htmlDomBindingsModule.getCanvas());
    gh.factory<int>(
    ...
    gh.factory<_i988.GaReporter>(() => _i1028.RealGaReporter());
    gh.factory<_i988.CanvasFactory>(() => _i1028.HtmlCanvasFactory());
    gh.factory<_i988.ImageDataFactory>(() => _i1028.HtmlImageDataFactory());
    gh.factory<int>(
      () => htmlDomBindingsModule.worldHeight,
      instanceName: 'world_height',
    );
    gh.factory<Function>(
      () => htmlDomBindingsModule.reload,
      instanceName: 'reload_function',
    );
    gh.factory<_i988.LocalStorage>(() => _i1028.HtmlLocalStorage());
    gh.factory<Map<String, List<String>>>(
      () => htmlDomBindingsModule.urlParams(),
...
class _$HtmlDomBindingsModule extends _i1028.HtmlDomBindingsModule {}

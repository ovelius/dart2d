...
function dart_precompiled($collectedClasses) {
  ...
  function Astroid(world, health, velocity, rotationVelocity, acceleration, collision, outOfBoundsMovesRemaining, position, _radius, size, imageIndex, angle, spriteType, color, alpha, frameIndex, frames, lifeTime, networkId, networkType, fullFramesOverNetwork, remove) {
    this.world = world;
    this.health = health;
    ...
    this.outOfBoundsMovesRemaining = outOfBoundsMovesRemaining;
    ...
    this.fullFramesOverNetwork = fullFramesOverNetwork;
    this.remove = remove;
  }
  Astroid.builtin$cls = "Astroid";
  if (!"name" in Astroid)
    Astroid.name = "Astroid";
  $desc = $collectedClasses.Astroid;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Astroid.prototype = $desc;
  ...
  function ConnectionWrapper(world, peerWrapper, id, connection, open, handshakeReceived, lastRemoteKeyFrame, lastLocalPeerKeyFrameVerified, droppedKeyFrames, remoteKeyState, keyFrameData) {
    this.world = world;
    this.peerWrapper = peerWrapper;
    this.id = id;
    this.connection = connection;
    this.open = open;
    this.handshakeReceived = handshakeReceived;
    this.lastRemoteKeyFrame = lastRemoteKeyFrame;
    this.lastLocalPeerKeyFrameVerified = lastLocalPeerKeyFrameVerified;
    this.droppedKeyFrames = droppedKeyFrames;
    this.remoteKeyState = remoteKeyState;
    this.keyFrameData = keyFrameData;
  }
  ConnectionWrapper.builtin$cls = "ConnectionWrapper";
  if (!"name" in ConnectionWrapper)
    ConnectionWrapper.name = "ConnectionWrapper";
  $desc = $collectedClasses.ConnectionWrapper;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ConnectionWrapper.prototype = $desc;
  ConnectionWrapper.prototype.get$id = function(receiver) {
    return this.id;
  };
  ConnectionWrapper.prototype.get$open = function(receiver) {
    return this.open;
  };
  ConnectionWrapper.prototype.get$lastLocalPeerKeyFrameVerified = function() {
    return this.lastLocalPeerKeyFrameVerified;
  };
  ConnectionWrapper.prototype.get$droppedKeyFrames = function() {
    return this.droppedKeyFrames;
  };
  function DamageProjectile(owner, damage, homingFactor, target, velocity, rotationVelocity, acceleration, collision, outOfBoundsMovesRemaining, position, _radius, size, imageIndex, angle, spriteType, color, alpha, frameIndex, frames, lifeTime, networkId, networkType, fullFramesOverNetwork, remove) {
    this.owner = owner;
    this.damage = damage;
    this.homingFactor = homingFactor;
    this.target = target;
  ...
  DamageProjectile.builtin$cls = "DamageProjectile";
  if (!"name" in DamageProjectile)
    DamageProjectile.name = "DamageProjectile";
  $desc = $collectedClasses.DamageProjectile;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DamageProjectile.prototype = $desc;
  ...
  function _HudMessage(message, remainingTime) {
    this.message = message;
    this.remainingTime = remainingTime;
  }
  _HudMessage.builtin$cls = "_HudMessage";
  if (!"name" in _HudMessage)
    _HudMessage.name = "_HudMessage";
  $desc = $collectedClasses._HudMessage;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _HudMessage.prototype = $desc;
  function HudMessages(world, messages) {
    this.world = world;
    this.messages = messages;
  }
  HudMessages.builtin$cls = "HudMessages";
  if (!"name" in HudMessages)
    HudMessages.name = "HudMessages";
  $desc = $collectedClasses.HudMessages;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HudMessages.prototype = $desc;
  function KeyState(world, debug, keysDown) {
    this.world = world;
    this.debug = debug;
    this.keysDown = keysDown;
  }
  KeyState.builtin$cls = "KeyState";
  if (!"name" in KeyState)
    KeyState.name = "KeyState";
  $desc = $collectedClasses.KeyState;
  if ($desc instanceof Array)
    $desc = $desc[1];
  KeyState.prototype = $desc;
  function MovingSprite(velocity, rotationVelocity, acceleration, collision, outOfBoundsMovesRemaining, position, _radius, size, imageIndex, angle, spriteType, color, alpha, frameIndex, frames, lifeTime, networkId, networkType, fullFramesOverNetwork, remove) {
    this.velocity = velocity;
    this.rotationVelocity = rotationVelocity;
    this.acceleration = acceleration;
    this.collision = collision;
  ...
  MovingSprite.builtin$cls = "MovingSprite";
  if (!"name" in MovingSprite)
    MovingSprite.name = "MovingSprite";
  $desc = $collectedClasses.MovingSprite;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MovingSprite.prototype = $desc;
  MovingSprite.prototype.get$velocity = function() {
    return this.velocity;
  };
  MovingSprite.prototype.get$rotationVelocity = function() {
    return this.rotationVelocity;
  };
  MovingSprite.prototype.set$rotationVelocity = function(v) {
    return this.rotationVelocity = v;
  };
  function Client(world, localPlayerName, peer, untilNextKeyFrame, currentKeyFrame) {
    this.world = world;
    this.localPlayerName = localPlayerName;
    this.peer = peer;
    this.untilNextKeyFrame = untilNextKeyFrame;
  ...
  function Server(world, localPlayerName, peer, untilNextKeyFrame, currentKeyFrame) {
    this.world = world;
    this.localPlayerName = localPlayerName;
    this.peer = peer;
    this.untilNextKeyFrame = untilNextKeyFrame;
  ...
  if (!"name" in Server)
    Server.name = "Server";
  $desc = $collectedClasses.Server;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Server.prototype = $desc;
  function Network() {
  }
  Network.builtin$cls = "Network";
  if (!"name" in Network)
    Network.name = "Network";
  $desc = $collectedClasses.Network;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Network.prototype = $desc;
  function RemotePlayerSprite(world, health, id, damageSprite, keyState, nextFireFrame, velocity, rotationVelocity, acceleration, collision, outOfBoundsMovesRemaining, position, _radius, size, imageIndex, angle, spriteType, color, alpha, frameIndex, frames, lifeTime, networkId, networkType, fullFramesOverNetwork, remove) {
    this.world = world;
    this.health = health;
    this.id = id;
    this.damageSprite = damageSprite;
    this.keyState = keyState;
    this.nextFireFrame = nextFireFrame;
    this.velocity = velocity;
    this.rotationVelocity = rotationVelocity;
    this.acceleration = acceleration;
    this.collision = collision;
  ...
  RemotePlayerSprite.builtin$cls = "RemotePlayerSprite";
  if (!"name" in RemotePlayerSprite)
    RemotePlayerSprite.name = "RemotePlayerSprite";
  $desc = $collectedClasses.RemotePlayerSprite;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RemotePlayerSprite.prototype = $desc;
  function LocalPlayerSprite(world, health, id, damageSprite, keyState, nextFireFrame, velocity, rotationVelocity, acceleration, collision, outOfBoundsMovesRemaining, position, _radius, size, imageIndex, angle, spriteType, color, alpha, frameIndex, frames, lifeTime, networkId, networkType, fullFramesOverNetwork, remove) {
    this.world = world;
    this.health = health;
    this.id = id;
    this.damageSprite = damageSprite;
  ...
  LocalPlayerSprite.builtin$cls = "LocalPlayerSprite";
  if (!"name" in LocalPlayerSprite)
    LocalPlayerSprite.name = "LocalPlayerSprite";
  $desc = $collectedClasses.LocalPlayerSprite;
  if ($desc instanceof Array)
    $desc = $desc[1];
  LocalPlayerSprite.prototype = $desc;
  LocalPlayerSprite.prototype.get$id = function(receiver) {
    return this.id;
  };
  function PeerWrapper(world, peer, connections) {
    this.world = world;
    this.peer = peer;
    this.connections = connections;
  }
  PeerWrapper.builtin$cls = "PeerWrapper";
  if (!"name" in PeerWrapper)
    PeerWrapper.name = "PeerWrapper";
  $desc = $collectedClasses.PeerWrapper;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PeerWrapper.prototype = $desc;
  function SpriteType(value) {
    this.value = value;
  }
  SpriteType.builtin$cls = "SpriteType";
  if (!"name" in SpriteType)
    SpriteType.name = "SpriteType";
  $desc = $collectedClasses.SpriteType;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SpriteType.prototype = $desc;
  SpriteType.prototype.get$value = function(receiver) {
    return this.value;
  };
  function NetworkType(_dart2d$_value) {
    this._dart2d$_value = _dart2d$_value;
  }
  NetworkType.builtin$cls = "NetworkType";
  if (!"name" in NetworkType)
    NetworkType.name = "NetworkType";
  $desc = $collectedClasses.NetworkType;
  if ($desc instanceof Array)
    $desc = $desc[1];
  NetworkType.prototype = $desc;
  function Sprite(position, size, imageIndex, angle, spriteType, frames, networkId, networkType, fullFramesOverNetwork, remove) {
    this.position = position;
    this.size = size;
    this.imageIndex = imageIndex;
    this.angle = angle;
  ...
  Sprite.prototype.get$imageIndex = function() {
    return this.imageIndex;
  };
  Sprite.prototype.get$angle = function() {
    return this.angle;
  };
  Sprite.prototype.set$angle = function(v) {
    return this.angle = v;
  };
  Sprite.prototype.get$spriteType = function() {
    return this.spriteType;
  };
  Sprite.prototype.set$spriteType = function(v) {
    return this.spriteType = v;
  };
  Sprite.prototype.get$frames = function() {
    return this.frames;
  };
  Sprite.prototype.set$frames = function(v) {
    return this.frames = v;
  };
  Sprite.prototype.get$networkId = function() {
    return this.networkId;
  };
  Sprite.prototype.get$networkType = function() {
    return this.networkType;
  };
  Sprite.prototype.get$fullFramesOverNetwork = function() {
    return this.fullFramesOverNetwork;
  };
  Sprite.prototype.set$fullFramesOverNetwork = function(v) {
    return this.fullFramesOverNetwork = v;
  };
  Sprite.prototype.get$remove = function(receiver) {
    return this.remove;
  };
  function StickySprite(stickTo, velocity, rotationVelocity, acceleration, collision, outOfBoundsMovesRemaining, position, _radius, size, imageIndex, angle, spriteType, color, alpha, frameIndex, frames, lifeTime, networkId, networkType, fullFramesOverNetwork, remove) {
    this.stickTo = stickTo;
    this.velocity = velocity;
    this.rotationVelocity = rotationVelocity;
    this.acceleration = acceleration;
  ...
  StickySprite.builtin$cls = "StickySprite";
  if (!"name" in StickySprite)
    StickySprite.name = "StickySprite";
  $desc = $collectedClasses.StickySprite;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StickySprite.prototype = $desc;
  function Vec2(x, y) {
    this.x = x;
    this.y = y;
  }
  Vec2.builtin$cls = "Vec2";
  if (!"name" in Vec2)
    Vec2.name = "Vec2";
  $desc = $collectedClasses.Vec2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Vec2.prototype = $desc;
  Vec2.prototype.get$x = function(receiver) {
    return this.x;
  };
  Vec2.prototype.set$x = function(receiver, v) {
    return this.x = v;
  };
  Vec2.prototype.get$y = function(receiver) {
    return this.y;
  };
  Vec2.prototype.set$y = function(receiver, v) {
    return this.y = v;
  };
  function World(peer, sprites, spriteNetworkId, waitingSprites, networkRemovals, removeSprites, hudMessages, localKeyState, drawFps, serverFps, loading, restart, network) {
    this.peer = peer;
    this.sprites = sprites;
    this.spriteNetworkId = spriteNetworkId;
    this.waitingSprites = waitingSprites;
    this.networkRemovals = networkRemovals;
  ...
  function FpsCounter(period, fps, nextTriggerIn, frames) {
    this.period = period;
    this.fps = fps;
    this.nextTriggerIn = nextTriggerIn;
    this.frames = frames;
  }
